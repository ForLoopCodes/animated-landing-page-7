...
export const HeroSection = () => {
  return (
    <section className="w-[94vw] h-screen rounded-4xl overflow-hidden bg-gradient-to-b from-blue-900 via-blue-900/50 via-black via-black via-black to-black text-white flex mt-30 mx-auto flex-col items-center text-center relative px-4 sm:px-6 lg:px-8 z-1">
      <Noise
        patternSize={100}
        patternScaleX={1}
        patternScaleY={1}
      ...
      <div className="relative antialiased w-full justify-center items-center absolute inset -top-[50vh] blur-2xl z-1">
        ...
        <div className="absolute w-full h-[100vh] bg-radial from-blue-500 saturate-[10] via-transparent to-transparent -top-[20vh]"></div>
        <div className="absolute w-full h-[100vh] bg-radial from-blue-500 saturate-[10] via-transparent to-transparent -top-[20vh]"></div>
      </div>
      <div className="w-full flex flex-col items-center justify-center pt-[14vh] pb-20 z-10 px-10 relative">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-shine text-white w-full max-w-4xl mt-8">
          Advanced{" "}
